...
If all goes correctly, you should see the string `/home/hadoop/hdfs/namenode has been successfully formatted.` somewhere in the massive amount of output generated by the second command. You can also cd to the namenode directory and see that it is no longer empty.
...
You are now in a world of pain, where nothing works and you have to debug obscure permission errors.
